...
public class Enroute_ship_change_returns_multiple_seat_maps extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"SeatMapService\\Enroute_ship_change_returns_multiple_seat_maps.xml"));
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"SeatMapService\\Enroute_ship_change_returns_multiple_seat_maps.xml";
