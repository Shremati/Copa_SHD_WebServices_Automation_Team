...
public class Get_Direct_Service_Display_Error_showing_unimplemented_method extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory() + "AirScheduleService\\Get_Direct_Service_Display_Error_showing_unimplemented_method.xml"));
        writer.write(response.asPrettyString());
        writer.close();

        Assert.assertTrue(response.getBody().asString().contains("The requested operation is not implemented in this application"), "Do not contain The requested operation is not implemented in this application");
...
//
        String filepath1;
        filepath1 = getRequestDirectory() + "AirScheduleService\\Get_Direct_Service_Display_Error_showing_unimplemented_method.xml";
