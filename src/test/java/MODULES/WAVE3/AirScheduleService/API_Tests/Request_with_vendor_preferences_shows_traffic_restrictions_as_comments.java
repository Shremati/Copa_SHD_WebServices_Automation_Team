...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        if(response.getBody().asString().contains("ONLINE CONEX/STPVR TFC ONLY"))
        {
            Assert.assertTrue(response.getBody().asString().contains("ONLINE CONEX/STPVR TFC ONLY"), "Do not contain ONLINE CONEX/STPVR TFC ONLY");
