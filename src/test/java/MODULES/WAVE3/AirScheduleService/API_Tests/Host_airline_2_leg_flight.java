...
public class Host_airline_2_leg_flight extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory() + "AirScheduleService\\Host_airline_2_leg_flight.xml"));
...
//
        String filepath1;
        filepath1 = getRequestDirectory() + "AirScheduleService\\Host_airline_2_leg_flight.xml";
