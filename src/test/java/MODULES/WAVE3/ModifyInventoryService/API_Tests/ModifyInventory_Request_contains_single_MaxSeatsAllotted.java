...
public class ModifyInventory_Request_contains_single_MaxSeatsAllotted extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        ExtentLogger.info("Base URL : " + getBaseURL() + getModifyinventoryservice());
