...
public class Display_API_pax_types_2adts_2infants_without_seats extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("RecordID=\"4\">0:APIS INCOMPLETE"),"Not contains RecordID=\"4\">0:APIS INCOMPLETE");
        ExtentLogger.info("Assertion passed - contains RecordID=\"4\">0:APIS INCOMPLETE");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"AdvancePassengerInfo\\Display_API_pax_types_2adts_2infants_without_seats.xml";
