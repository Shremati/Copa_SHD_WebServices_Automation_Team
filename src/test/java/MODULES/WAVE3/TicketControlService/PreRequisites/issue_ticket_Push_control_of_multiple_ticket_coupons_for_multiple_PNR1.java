...
public class issue_ticket_Push_control_of_multiple_ticket_coupons_for_multiple_PNR1 extends FrameworkConstants {
...
//        ********** Reading Testdata from Excel ************
        ...
        String filepath1;
        filepath1=".\\src\\test\\java\\MODULES\\WAVE3\\TicketControlService\\PreRequisites\\issue_ticket_Push_control_of_multiple_ticket_coupons_for_multiple_PNR1.xml";
    ...
    public static void excelwriter() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        InputRow.getCell(20).setCellValue(TicketNumber);
        InputRow.getCell(21).setCellValue(TicketNumber);
        InputRow.getCell(23).setCellValue(TicketNumber);
        InputRow.getCell(24).setCellValue(TicketNumber);
