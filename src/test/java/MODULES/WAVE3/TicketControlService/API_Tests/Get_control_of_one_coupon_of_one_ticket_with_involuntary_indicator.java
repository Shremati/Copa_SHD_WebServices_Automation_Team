...
public class Get_control_of_one_coupon_of_one_ticket_with_involuntary_indicator extends FrameworkConstants {
        ...
        public static void Execute() throws IOException, ParserConfigurationException, TransformerException, SAXException
        {
            ...
            issue_ticket_Get_control_of_one_coupon_of_one_ticket_with_involuntary_indicator Prerequisite2 = new issue_ticket_Get_control_of_one_coupon_of_one_ticket_with_involuntary_indicator();
            Prerequisite2.run();

            ExtentLogger.info("Prerequisite 3");
            display_ticket_Get_control_of_one_coupon_of_one_ticket_with_involuntary_indicator Prerequisite3 = new display_ticket_Get_control_of_one_coupon_of_one_ticket_with_involuntary_indicator();
            Prerequisite3.run();
...
//    ******** Read the updated request and send it to fetch the response *********
            ...
            BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"TicketControlService\\Get_control_of_one_coupon_of_one_ticket_with_involuntary_indicator.xml"));
...
//                ********* Clearing Temp_Request.xml *********
        ...
        public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
        {
            ...
            String filepath1;
            filepath1=getRequestDirectory()+"TicketControlService\\Get_control_of_one_coupon_of_one_ticket_with_involuntary_indicator.xml";
