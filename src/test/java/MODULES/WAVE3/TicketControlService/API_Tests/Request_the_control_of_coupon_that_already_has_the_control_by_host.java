...
public class Request_the_control_of_coupon_that_already_has_the_control_by_host extends FrameworkConstants {
...
//        }while(!flightFound);
        ...
        display_ticket_Request_the_control_of_coupon_that_already_has_the_control_by_host Prerequisite3 = new display_ticket_Request_the_control_of_coupon_that_already_has_the_control_by_host();
        Prerequisite3.run();
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"TicketControlService\\Request_the_control_of_coupon_that_already_has_the_control_by_host.xml"));
        ...
        Assert.assertTrue(response.getBody().asString().contains("HOST ALREADY HAS CONTROL"),"Expected HOST ALREADY HAS CONTROL, but not found");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"TicketControlService\\Request_the_control_of_coupon_that_already_has_the_control_by_host.xml";
