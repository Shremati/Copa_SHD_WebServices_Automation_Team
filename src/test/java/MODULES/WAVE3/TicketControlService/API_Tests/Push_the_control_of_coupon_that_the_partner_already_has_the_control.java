...
public class Push_the_control_of_coupon_that_the_partner_already_has_the_control extends FrameworkConstants {
    ...
    public static void Execute() throws IOException, ParserConfigurationException, TransformerException, SAXException
    {
        ...
        display_ticket_Push_the_control_of_coupon_that_the_partner_already_has_the_control Prerequisite3 = new display_ticket_Push_the_control_of_coupon_that_the_partner_already_has_the_control();
        Prerequisite3.run();
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"TicketControlService\\Push_the_control_of_coupon_that_the_partner_already_has_the_control.xml"));
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"TicketControlService\\Push_the_control_of_coupon_that_the_partner_already_has_the_control.xml";
