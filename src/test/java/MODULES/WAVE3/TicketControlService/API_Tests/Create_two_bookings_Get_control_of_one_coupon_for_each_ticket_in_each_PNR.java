...
public class Create_two_bookings_Get_control_of_one_coupon_for_each_ticket_in_each_PNR extends FrameworkConstants {
    ...
    public static void Execute() throws IOException, ParserConfigurationException, TransformerException, SAXException
    {
        ...
        Issue_ticket_Get_control_of_one_coupon_for_each_ticket_in_each_PNR_1 Prerequisite2 = new Issue_ticket_Get_control_of_one_coupon_for_each_ticket_in_each_PNR_1();
        Prerequisite2.run();

        ExtentLogger.info("Prerequisite 3");
        Display_ticket_Get_control_of_one_coupon_for_each_ticket_in_each_PNR_1 Prerequisite3 = new Display_ticket_Get_control_of_one_coupon_for_each_ticket_in_each_PNR_1();
        Prerequisite3.run();
        ...
        Issue_ticket_Get_control_of_one_coupon_for_each_ticket_in_each_PNR_2 Prerequisite5 = new Issue_ticket_Get_control_of_one_coupon_for_each_ticket_in_each_PNR_2();
        Prerequisite5.run();

        ExtentLogger.info("Prerequisite 6");
        Display_ticket_Get_control_of_one_coupon_for_each_ticket_in_each_PNR_2 Prerequisite6 = new Display_ticket_Get_control_of_one_coupon_for_each_ticket_in_each_PNR_2();
        Prerequisite6.run();
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"TicketControlService\\Create_two_bookings_Get_control_of_one_coupon_for_each_ticket_in_each_PNR.xml"));
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"TicketControlService\\Create_two_bookings_Get_control_of_one_coupon_for_each_ticket_in_each_PNR.xml";
