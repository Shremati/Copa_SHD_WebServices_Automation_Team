...
public class error_data_page_does_not_exist extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory() + "ReferenceService\\error_data_page_does_not_exist.xml"));
        writer.write(response.asPrettyString());
        writer.close();
        ;
        Assert.assertTrue(response.getBody().asString().contains("DATA PAGE DOES NOT EXIST"),
                "Do not have DATA PAGE DOES NOT EXIST");
        ExtentLogger.info("Assertion passed - contains DATA PAGE DOES NOT EXIST");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException {
        ...
        String filepath1;
        filepath1 = getRequestDirectory() + "ReferenceService\\error_data_page_does_not_exist.xml";
