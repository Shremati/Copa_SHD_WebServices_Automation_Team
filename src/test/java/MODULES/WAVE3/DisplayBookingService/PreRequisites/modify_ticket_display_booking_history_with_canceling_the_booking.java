...
public class modify_ticket_display_booking_history_with_canceling_the_booking extends FrameworkConstants
{
...
//        ********** Reading Testdata from Excel ************
        ...
        String filepath1;
        filepath1=".\\src\\test\\java\\MODULES\\WAVE3\\DisplayBookingService\\PreRequisites\\modify_ticket_display_booking_history_with_canceling_the_booking.xml";
        ...
        XMLParser.updateAttributeValueatIndex("air1:FlightSegment","ArrivalDateTime", InputRow.getCell(21).getStringCellValue(),getTemp_requestPath(),0);
        ...
        XMLParser.updateAttributeValueatIndex("air1:FlightSegment","ArrivalDateTime", InputRow.getCell(22).getStringCellValue(),getTemp_requestPath(),1);
