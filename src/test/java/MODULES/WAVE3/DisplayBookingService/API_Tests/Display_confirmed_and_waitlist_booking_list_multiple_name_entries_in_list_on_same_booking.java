...
import MODULES.WAVE3.DisplayBookingService.PreRequisites.Create_booking_1_Display_confirmed_and_waitlist_booking_list_multiple_name_entries_in_list_on_same_booking;
...
import MODULES.WAVE3.DisplayBookingService.PreRequisites.Create_booking_2_Display_confirmed_and_waitlist_booking_list_multiple_name_entries_in_list_on_same_booking;
...
public class Display_confirmed_and_waitlist_booking_list_multiple_name_entries_in_list_on_same_booking extends FrameworkConstants {
...
//        Create_booking_1_Display_confirmed_and_waitlist_booking_list_multiple_name_entries_in_list_on_same_booking Prerequisite = new Create_booking_1_Display_confirmed_and_waitlist_booking_list_multiple_name_entries_in_list_on_same_booking();
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"DisplayBookingService\\Display_confirmed_and_waitlist_booking_list_multiple_name_entries_in_list_on_same_booking.xml"));
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"DisplayBookingService\\Display_confirmed_and_waitlist_booking_list_multiple_name_entries_in_list_on_same_booking.xml";
