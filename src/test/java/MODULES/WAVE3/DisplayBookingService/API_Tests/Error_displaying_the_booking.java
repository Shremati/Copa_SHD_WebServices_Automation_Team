...
public class Error_displaying_the_booking extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("UNBL TO RTRV PNR"), "Does not contain \"UNBL TO RTRV PNR\" in the response");
        ExtentLogger.info("Assertion passed - contains \"UNBL TO RTRV PNR\"");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"DisplayBookingService\\Error_displaying_the_booking.xml";
