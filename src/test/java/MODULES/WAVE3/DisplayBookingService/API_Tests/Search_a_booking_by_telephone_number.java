...
import MODULES.WAVE3.DisplayBookingService.PreRequisites.Create_Booking_1_Search_a_booking_by_telephone_number;
import MODULES.WAVE3.DisplayBookingService.PreRequisites.Create_Booking_2_Search_a_booking_by_telephone_number;
...
public class Search_a_booking_by_telephone_number extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"DisplayBookingService\\Search_a_booking_by_telephone_number.xml"));
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"DisplayBookingService\\Search_a_booking_by_telephone_number.xml";
