...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("Exception Caught While Retrieving Booking"), "Does not contain \"Exception Caught While Retrieving Booking\" in the response");
        ExtentLogger.info("Assertion passed - contains \"Exception Caught While Retrieving Booking\"");
