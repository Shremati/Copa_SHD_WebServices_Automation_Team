...
import MODULES.WAVE3.ModifyTicketingService.PreRequisites.issue_ticket_print_an_eticket;
...
public class Print_an_eticket extends FrameworkConstants
{
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("INVALID ETKT ITEM NUMBER"), "Does not contain \"INVALID ETKT ITEM NUMBER\" in the response");
        ExtentLogger.info("Assertion passed - contains \"INVALID ETKT ITEM NUMBER\"");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"ModifyTicketingService\\Print_an_eticket.xml";
