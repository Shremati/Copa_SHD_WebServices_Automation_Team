...
public class Direct_and_nonstop_flights_is_false_applied_to_all_requests extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"Availability\\Direct_and_nonstop_flights_is_false_applied_to_all_requests.xml"));
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"Availability\\Direct_and_nonstop_flights_is_false_applied_to_all_requests.xml";
