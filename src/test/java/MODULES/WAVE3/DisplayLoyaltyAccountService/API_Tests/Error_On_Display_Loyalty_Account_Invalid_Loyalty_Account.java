...
public class Error_On_Display_Loyalty_Account_Invalid_Loyalty_Account extends FrameworkConstants
{
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("Unable to display loyalty account -  (1) INVLD ENT<"),
                "Do not contain message: Unable to display loyalty account -  (1) INVLD ENT<");
