...
public class Decode_country_US extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("ConversionRequest=\"US\""),
                "Do not contain ConversionRequest=\"US\"");
        ExtentLogger.info("Assertion passed - contains ConversionRequest=\"US\"");

        Assert.assertTrue(response.getBody().asString().contains("CountryConversion"),
                "Do not contain CountryConversion");
        ...
        Assert.assertTrue(response.getBody().asString().contains("<ns4:CountryName>UNITED STATES OF AMERICA</ns4:CountryName>"),
                "Do not contain <ns4:CountryName>UNITED STATES OF AMERICA</ns4:CountryName>");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"EncodeDecodeService\\Decode_country_US.xml";
