...
public class Decode_city_code_LAX_specifying_a_duty_code_for_sign_in extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"EncodeDecodeService\\Decode_city_code_LAX_specifying_a_duty_code_for_sign_in.xml"));
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"EncodeDecodeService\\Decode_city_code_LAX_specifying_a_duty_code_for_sign_in.xml";
