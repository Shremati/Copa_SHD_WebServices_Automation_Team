...
public class Decode_city_code_LAX_specifying_agent_sine_duty_code_airport_code_and_ERSP_psswrd_for_sign_in extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("ConversionRequest=\"lax\""),
                "Do not have ConversionRequest=\"lax\"");
        ...
        Assert.assertTrue(response.getBody().asString().contains("<CountryName>UNITED STATES OF AMERICA</CountryName>"),
                "Do noto contain <CountryName>UNITED STATES OF AMERICA</CountryName>");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException {
        ...
        String filepath1;
        filepath1 = getRequestDirectory() + "EncodeDecodeService\\Decode_city_code_LAX_specifying_agent_sine_duty_code_airport_code_and_ERSP_psswrd_for_sign_in.xml";
