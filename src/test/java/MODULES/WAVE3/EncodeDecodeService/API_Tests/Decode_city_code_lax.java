...
public class Decode_city_code_lax extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("LOS ANGELES"), "Do not contain LOS ANGELES");
