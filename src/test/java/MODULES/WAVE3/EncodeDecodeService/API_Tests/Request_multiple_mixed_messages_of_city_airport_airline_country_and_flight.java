...
public class Request_multiple_mixed_messages_of_city_airport_airline_country_and_flight extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory() + "EncodeDecodeService\\Request_multiple_mixed_messages_of_city_airport_airline_country_and_flight.xml"));
        ...
        Assert.assertTrue(response.getBody().asString().contains("UNITED STATES OF AMERICA"));
        ExtentLogger.info("Assertion passed - contains UNITED STATES OF AMERICA");

        Assertions.AssertWarning(response, false);
        ExtentLogger.info("Assertion passed - do not have warinngs");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException {
        ...
        String filepath1;
        filepath1 = getRequestDirectory() + "EncodeDecodeService\\Request_multiple_mixed_messages_of_city_airport_airline_country_and_flight.xml";
