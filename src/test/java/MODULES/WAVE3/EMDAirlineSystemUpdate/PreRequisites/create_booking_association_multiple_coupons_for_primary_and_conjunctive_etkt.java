...
//        XMLParser.updateAttributeValueatIndex("air1:FlightSegment","FlightNumber",InputRow.getCell(10).getStringCellValue(),getTemp_requestPath(),2);
        ...
        XMLParser.updateAttributeValue("air1:FlightSegment", "FlightNumber", availableFlights.get(InputRow.getCell(11).getStringCellValue() + "-" + InputRow.getCell(12).getStringCellValue()).get(i), getTemp_requestPath());
...
//        XMLParser.updateAttributeValueatIndex("air1:FlightSegment","FlightNumber",InputRow.getCell(14).getStringCellValue(),getTemp_requestPath(),3);
        ...
        XMLParser.updateAttributeValue("air1:FlightSegment", "FlightNumber", availableFlights.get(InputRow.getCell(15).getStringCellValue() + "-" + InputRow.getCell(16).getStringCellValue()).get(i), getTemp_requestPath());
...
//        XMLParser.updateAttributeValueatIndex("air1:FlightSegment","FlightNumber",InputRow.getCell(18).getStringCellValue(),getTemp_requestPath(),4);
        ...
        XMLParser.updateAttributeValue("air1:FlightSegment", "FlightNumber", availableFlights.get(InputRow.getCell(19).getStringCellValue() + "-" + InputRow.getCell(20).getStringCellValue()).get(i), getTemp_requestPath());
...
//        XMLParser.updateAttributeValueatIndex("air1:FlightSegment","FlightNumber",InputRow.getCell(29).getStringCellValue(),getTemp_requestPath(),5);
        ...
        XMLParser.updateAttributeValue("air1:FlightSegment", "FlightNumber", availableFlights.get(InputRow.getCell(30).getStringCellValue() + "-" + InputRow.getCell(31).getStringCellValue()).get(i), getTemp_requestPath());
    ...
    public static void excelwriter(int i) throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        InputRow.getCell(10).setCellValue(availableFlights.get(InputRow.getCell(11).getStringCellValue() + "-" + InputRow.getCell(12).getStringCellValue()).get(i));
        InputRow.getCell(14).setCellValue(availableFlights.get(InputRow.getCell(15).getStringCellValue() + "-" + InputRow.getCell(16).getStringCellValue()).get(i));
        ...
        InputRow.getCell(29).setCellValue(availableFlights.get(InputRow.getCell(30).getStringCellValue() + "-" + InputRow.getCell(31).getStringCellValue()).get(i));
