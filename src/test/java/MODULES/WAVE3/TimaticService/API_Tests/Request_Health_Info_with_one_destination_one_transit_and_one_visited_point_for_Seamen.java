...
public class Request_Health_Info_with_one_destination_one_transit_and_one_visited_point_for_Seamen extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"TimaticService\\Request_Health_Info_with_one_destination_one_transit_and_one_visited_point_for_Seamen.xml"));
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"TimaticService\\Request_Health_Info_with_one_destination_one_transit_and_one_visited_point_for_Seamen.xml";

        XMLParser.updateAttributeValueatIndex("air:Country","Code",InputRow.getCell(3).getStringCellValue(),filepath1,1);
