...
public class display_for_section_Visa_with_its_subsection_notes extends FrameworkConstants {
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        XSSFRow InputRow=sheet.getRow(50);

        String filepath1;
        filepath1=getRequestDirectory()+"TimaticService\\display_for_section_Visa_with_its_subsection_notes.xml";
