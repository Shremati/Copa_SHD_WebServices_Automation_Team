...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("PassportType=\"SEAMAN\""),"Not contains in reponse PassportType=\"SEAMAN\"");
        ExtentLogger.info("Assertion passed - contains PassportType=\"SEAMAN\"");
