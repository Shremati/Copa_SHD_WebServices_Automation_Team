...
public class Request_Vias_Health_Info_with_one_destination_one_transit_and_one_visited_point extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"TimaticService\\Request_Vias_Health_Info_with_one_destination_one_transit_and_one_visited_point.xml"));
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        XSSFRow InputRow=sheet.getRow(26);

        String filepath1;
        filepath1=getRequestDirectory()+"TimaticService\\Request_Vias_Health_Info_with_one_destination_one_transit_and_one_visited_point.xml";
