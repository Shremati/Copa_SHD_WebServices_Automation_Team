...
public class Request_Health_Info_with_multi_destination_transit_and_visited_points_for_gov extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"TimaticService\\Request_Health_Info_with_multi_destination_transit_and_visited_points_for_seamen.xml"));
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"TimaticService\\Request_Health_Info_with_multi_destination_transit_and_visited_points_for_seamen.xml";
        ...
        XMLParser.updateAttributeValueatIndex("air:Country","Code",InputRow.getCell(12).getStringCellValue(),getTemp_requestPath(),3);
        ...
        XMLParser.updateAttributeValueatIndex("air:Country","Code",InputRow.getCell(10).getStringCellValue(),getTemp_requestPath(),5);
