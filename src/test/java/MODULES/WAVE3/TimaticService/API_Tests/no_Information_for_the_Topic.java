...
public class no_Information_for_the_Topic extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"TimaticService\\no_Information_for_the_Topic.xml"));
        ...
        ExtentLogger.info("Assertion passed - contains \"SUBSECTION EXEMPT (EM) HAS NO INFORMATION\"");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        XSSFRow InputRow=sheet.getRow(69);

        String filepath1;
        filepath1=getRequestDirectory()+"TimaticService\\no_Information_for_the_Topic.xml";
