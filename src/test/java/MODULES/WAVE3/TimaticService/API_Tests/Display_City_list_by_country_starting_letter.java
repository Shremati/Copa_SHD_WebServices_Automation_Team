...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("INVALID RESPONSE"),"Not contains \"INVALID RESPONSE\" in response");
        ExtentLogger.info("Assertion passed - contains \"INVALID RESPONSE\"");
