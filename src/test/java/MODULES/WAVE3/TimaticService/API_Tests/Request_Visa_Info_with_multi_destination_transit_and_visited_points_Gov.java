...
public class Request_Visa_Info_with_multi_destination_transit_and_visited_points_Gov extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"TimaticService\\Request_Visa_Info_with_multi_destination_transit_and_visited_points_Gov.xml"));
        ...
        Assert.assertTrue(response.getBody().asString().contains("PassportType=\"NORMAL\""),"Not contains in response PassportType=\"NORMAL\"");
        ExtentLogger.info("Assertion passed - contains PassportType=\"NORMAL\"");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"TimaticService\\Request_Visa_Info_with_multi_destination_transit_and_visited_points_Gov.xml";
        ...
        XMLParser.updateAttributeValueatIndex("air:Country","Code",InputRow.getCell(10).getStringCellValue(),getTemp_requestPath(),3);
        XMLParser.updateAttributeValueatIndex("air:Country","Code",InputRow.getCell(11).getStringCellValue(),getTemp_requestPath(),5);
        XMLParser.updateAttributeValueatIndex("air:Country","Code",InputRow.getCell(5).getStringCellValue(),getTemp_requestPath(),4);
