...
public class display_for_section_Health_with_its_subsection_for_warning extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"TimaticService\\display_for_section_Health_with_its_subsection_for_warning.xml"));
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        XSSFRow InputRow=sheet.getRow(66);

        String filepath1;
        filepath1=getRequestDirectory()+"TimaticService\\display_for_section_Health_with_its_subsection_for_warning.xml";
