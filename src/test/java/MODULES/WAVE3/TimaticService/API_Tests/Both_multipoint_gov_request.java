...
public class Both_multipoint_gov_request extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("INPUT FORMAT ERROR"),"Not contains \"INPUT FORMAT ERROR\" in response");
        ExtentLogger.info("Assertion passed - contains \"INPUT FORMAT ERROR\"");
