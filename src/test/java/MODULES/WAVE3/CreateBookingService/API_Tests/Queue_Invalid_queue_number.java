...
public class Queue_Invalid_queue_number extends FrameworkConstants {
...
//                       ********** Reading the xml request file **********
        ...
        Assert.assertTrue(response.getBody().asString().contains("No queue number specified"));
        ExtentLogger.info("Response contains \"No queue number specified\"");
...
//        ********** Reading Testdata from Excel ************
    ...
    public static void excelwriter() throws IOException, ParserConfigurationException, SAXException, TransformerException {
        ...
        String filepath;
        filepath = getResponseDirectory() + "CreateBookingService\\Queue_Invalid_queue_number.xml";
