...
public class Stored_fare_Ticketing_item_Invalid_tour_code extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("Error Response to Add Tour Code Transaction -  (1) INVALID TOUR CODE/EMPLOYEE ID (2) /FLWG DATA NOT ENTERED/PROCESSED:"),
                "Error Response to Add Tour Code Transaction -  (1) INVALID TOUR CODE/EMPLOYEE ID (2) /FLWG DATA NOT ENTERED/PROCESSED:");
        ExtentLogger.info("Assertion passed - contain Error Response to Add Tour Code Transaction -  (1) INVALID TOUR CODE/EMPLOYEE ID (2) /FLWG DATA NOT ENTERED/PROCESSED:");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException {
        ...
        String filepath1;
        filepath1 = getRequestDirectory() + "CreateBookingService\\Stored_fare_Ticketing_item_Invalid_tour_code.xml";
