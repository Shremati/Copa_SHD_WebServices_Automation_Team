...
public class waitlist_booking_action_code_LL extends FrameworkConstants
{
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("<ns3:Remark>FOR WAITLIST TEST</ns3:Remark>"),
                "Do not contain FOR WAITLIST TEST");
        ExtentLogger.info("Assertion passed - contain FOR WAITLIST TEST");
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException {
        ...
        String filepath1;
        filepath1 = getRequestDirectory() + "CreateBookingService\\waitlist_booking_action_code_LL.xml";
