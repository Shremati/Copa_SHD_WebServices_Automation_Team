...
public class special_passenger_type_jumpseat extends FrameworkConstants
{
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory() + "CreateBookingService\\special_passenger_type_jumpseat.xml"));
        ...
        Assert.assertTrue(response.getBody().asString().contains("<ns3:Remark>JUMPSEAT BOOKING</ns3:Remark>"),
                "Do not contain JUMPSEAT BOOKING");
        ExtentLogger.info("Assertion passed - contain JUMPSEAT BOOKING");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload(int i) throws IOException, ParserConfigurationException, SAXException, TransformerException {
        ...
        String filepath1;
        filepath1 = getRequestDirectory() + "CreateBookingService\\special_passenger_type_jumpseat.xml";
    ...
    public static void excelwriter(int i) throws IOException, ParserConfigurationException, SAXException, TransformerException {
        ...
        String filepath;
        filepath = getResponseDirectory() + "CreateBookingService\\special_passenger_type_jumpseat.xml";
