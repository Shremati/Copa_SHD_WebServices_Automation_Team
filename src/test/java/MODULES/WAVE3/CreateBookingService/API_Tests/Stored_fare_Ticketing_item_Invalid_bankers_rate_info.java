...
public class Stored_fare_Ticketing_item_Invalid_bankers_rate_info extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("Invalid Bankers Rate currency code."), "Do not contain Invalid Bankers Rate currency code.");
        ExtentLogger.info("Assertion passed - contain Invalid Bankers Rate currency code");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException {
        ...
        String filepath1;
        filepath1 = getRequestDirectory() + "CreateBookingService\\Stored_fare_Ticketing_item_Invalid_bankers_rate_info.xml";
