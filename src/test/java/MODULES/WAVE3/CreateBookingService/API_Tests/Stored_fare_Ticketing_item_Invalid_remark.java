...
public class Stored_fare_Ticketing_item_Invalid_remark extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("Invalid free-flow remark: 1"), "Do not contain Invalid free-flow remark: 1");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException {
        ...
        String filepath1;
        filepath1 = getRequestDirectory() + "CreateBookingService\\Stored_fare_Ticketing_item_Invalid_remark.xml";
