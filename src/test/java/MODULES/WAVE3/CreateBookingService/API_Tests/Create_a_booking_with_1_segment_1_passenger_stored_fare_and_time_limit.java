...
public class Create_a_booking_with_1_segment_1_passenger_stored_fare_and_time_limit extends FrameworkConstants {
...
//                       ********** Reading the xml request file **********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory() + "CreateBookingService\\Create_a_booking_with_1_segment_1_passenger_stored_fare_and_time_limit.xml"));
...
//        ********** Reading Testdata from Excel ************
        ...
        XSSFRow InputRow = sheet.getRow(40);


        String filepath1;
        filepath1 = getRequestDirectory() + "CreateBookingService\\Create_a_booking_with_1_segment_1_passenger_stored_fare_and_time_limit.xml";
...
//        XMLParser.updateAttributeValue("air1:FlightSegment", "FlightNumber", InputRow.getCell(2).getStringCellValue(), getTemp_requestPath());
    ...
    public static void excelwriter() throws IOException, ParserConfigurationException, SAXException, TransformerException {
        ...
        String filepath;
        filepath = getResponseDirectory() + "CreateBookingService\\Create_a_booking_with_1_segment_1_passenger_stored_fare_and_time_limit.xml";
