...
public class Stored_fare_Ticketing_item_Invalid_original_issued_info extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        ExtentLogger.logXMLResponse(response.asPrettyString());
            if(response.getBody().asString().contains("Success") && response.getBody().asString().contains("Error Response to Add Original Issued Transaction -  (1) INVALID TICKET NBR-ORIG ISSUE (2) /FLWG DATA NOT ENTERED/PROCESSED:") ){
                flightFound = true;
            }
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload(int i) throws IOException, ParserConfigurationException, SAXException, TransformerException {
        ...
        String filepath1;
        filepath1 = getRequestDirectory() + "CreateBookingService\\Stored_fare_Ticketing_item_Invalid_original_issued_info.xml";
