...
public class Stored_fare_Ticketing_item_Invalid_original_origin_destination_city extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        ExtentLogger.logXMLResponse(response.asPrettyString());
            if(response.getBody().asString().contains("Success") && response.getBody().asString().contains("Error Response to Add original origin/destination city Transaction -  (1) INVALID CITY CODE S) (2) /FLWG DATA NOT ENTERED/PROCESSED:")){
                flightFound = true;
            }
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload(int i) throws IOException, ParserConfigurationException, SAXException, TransformerException {
        ...
        String filepath1;
        filepath1 = getRequestDirectory() + "CreateBookingService\\Stored_fare_Ticketing_item_Invalid_original_origin_destination_city.xml";
