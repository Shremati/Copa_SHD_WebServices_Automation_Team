...
public class Create_NonTicketed_PNR extends FrameworkConstants
{
...
//        ********** Reading Testdata from Excel ************
        ...
        String filepath1;
        filepath1=".\\src\\test\\java\\MODULES\\WAVE3\\DisplayTicketService\\PreRequisites\\Create_NonTicketed_PNR.xml";
...
//        InputRow.getCell(5).setCellValue(XMLParser.GetAttributeValueatIndex("ns3:FlightSegment","FlightNumber",getTemp_responsePath(),0));
        InputRow.getCell(5).setCellValue(availableFlights.get(InputRow.getCell(6).getStringCellValue() + "-" + InputRow.getCell(7).getStringCellValue()).get(i));
