...
import MODULES.WAVE3.DisplayTicketService.PreRequisites.Create_Booking_Conjunctive_ticket_primary_conjunctive;
import MODULES.WAVE3.DisplayTicketService.PreRequisites.Issue_ticket_Conjunctive_ticket_primary_conjunctive;
...
public class Conjunctive_ticket_primary_conjunctive extends FrameworkConstants {
    ...
    public static void Execute() throws IOException, ParserConfigurationException, TransformerException, SAXException
    {
        ...
        Create_Booking_Conjunctive_ticket_primary_conjunctive Prerequisite1 = new Create_Booking_Conjunctive_ticket_primary_conjunctive();
        Prerequisite1.run();
        ExtentLogger.info("Prerequisite1");

        Issue_ticket_Conjunctive_ticket_primary_conjunctive Prerequisite2 = new Issue_ticket_Conjunctive_ticket_primary_conjunctive();
        Prerequisite2.run();
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"DisplayTicketService\\Conjunctive_ticket_primary_conjunctive.xml"));
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        filepath1=getRequestDirectory()+"DisplayTicketService\\Conjunctive_ticket_primary_conjunctive.xml";
        ...
        XMLParser.updateAttributeValueatIndex("dis1:TicketDocument","TicketDocumentNbr",TicketDocumentNbr,filepath1, 0);
        XMLParser.updateAttributeValueatIndex("dis1:TicketDocument","TicketDocumentNbr",TicketDocumentNbr,getTemp_requestPath(), 1);
