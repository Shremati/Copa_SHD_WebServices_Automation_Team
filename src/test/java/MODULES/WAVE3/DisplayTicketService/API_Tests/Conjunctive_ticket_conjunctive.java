...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("FormAndSerialNumber" + Conjunctive_Ticket1 +"FormAndSerialNumber"), "Does not contain FormAndSerialNumber");
        ExtentLogger.info("Assertion passed - contains " + Conjunctive_Ticket1);

        Assert.assertTrue(response.getBody().asString().contains("FormAndSerialNumber" + Conjunctive_Ticket2 +"FormAndSerialNumber"), "Does not contain FormAndSerialNumber");
