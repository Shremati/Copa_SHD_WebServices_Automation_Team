...
import MODULES.WAVE3.Checkin.PreRequisites.Create_bokking_thru_checkin;
...
public class Thru_CheckIn_2_passengers_in_same_PNR extends FrameworkConstants {
    ...
    public static void Execute() throws IOException, ParserConfigurationException, TransformerException, SAXException
    {
        ...
        Create_bokking_thru_checkin Prerequisite1 = new Create_bokking_thru_checkin();
        Prerequisite1.run();

        ExtentLogger.info("Prerequisite 2");
        Issue_ticket_thru_checkin Prerequisite2 = new Issue_ticket_thru_checkin();
        Prerequisite2.run();

        ExtentLogger.info("Prerequisite 3");
        Display_APIS_Thru_pax Prerequisite3 = new Display_APIS_Thru_pax();
        Prerequisite3.run();
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("RecordID=\"1\"> (1) SEATS ASSIGNED"),"Not contains in response RecordID=\"1\"> (1) SEATS ASSIGNED");
        ExtentLogger.info("Assertion passed - contains RecordID=\"1\"> (1) SEATS ASSIGNED");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"Checkin\\Thru_CheckIn_2_passengers_in_same_PNR.xml";
