...
public class Get_summary_map_info extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"DepartureControlDisplay\\Get_summary_map_info.xml"));
        ...
        Assert.assertTrue(response.getBody().asString().contains("SeatSummaryInfo"), "Does not contain \"SeatSummaryInfo\" in the response");
        ExtentLogger.info("Assertion passed - contains \"SeatSummaryInfo\"");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"DepartureControlDisplay\\Get_summary_map_info.xml";
