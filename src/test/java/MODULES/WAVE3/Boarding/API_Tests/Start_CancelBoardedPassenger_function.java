...
public class Start_CancelBoardedPassenger_function extends FrameworkConstants
{
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("Function=\"CancelBoardedPassenger\""), "Does not contain \"Function=\"CancelBoardedPassenger\"\" in the response");
        ExtentLogger.info("Assertion passed - contains \"Function=\"CancelBoardedPassenger\"\"");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        filepath1=getRequestDirectory()+"Boarding\\Start_CancelBoardedPassenger_function.xml";
