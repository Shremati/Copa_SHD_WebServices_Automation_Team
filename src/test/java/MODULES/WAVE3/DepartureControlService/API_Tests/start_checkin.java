...
public class start_checkin extends FrameworkConstants
{
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        ExtentLogger.logXMLResponse(response.asPrettyString());
            ...
            if(response.getBody().asString().contains("Success") && response.getBody().asString().contains("StartCheckIn")){
                flightFound = true;
            }
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"DepartureControlService\\start_checkin.xml"));
        ...
        Assert.assertTrue(response.getBody().asString().contains("StartCheckIn"),"Not contains StartCheckIn in response");
        ExtentLogger.info("Assertion passed - contains StartCheckIn");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload(int i) throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"DepartureControlService\\start_checkin.xml";
