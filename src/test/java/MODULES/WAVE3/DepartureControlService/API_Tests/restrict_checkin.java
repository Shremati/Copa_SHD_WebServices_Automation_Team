...
public class restrict_checkin extends FrameworkConstants
{
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("RestrictCheckInToGate"),"Not contains RestrictCheckInToGate in response");
        ExtentLogger.info("Assertion passed - contains RestrictCheckInToGate");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"DepartureControlService\\restrict_checkin.xml";
