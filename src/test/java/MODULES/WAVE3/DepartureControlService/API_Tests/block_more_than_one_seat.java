...
public class block_more_than_one_seat extends FrameworkConstants
{
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        ExtentLogger.logXMLResponse(response.asPrettyString());
            ...
            if(response.getBody().asString().contains("Success") && response.getBody().asString().contains("BlockSeat")){
                flightFound = true;
            }
        ...
        Assert.assertTrue(response.getBody().asString().contains("BlockSeat"),"Not contains BlockSeat in response");
        ExtentLogger.info("Assertion passed - contains BlockSeat");
