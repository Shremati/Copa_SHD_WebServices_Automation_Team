...
public class error_on_block_seat_invalid_seat_number extends FrameworkConstants
{
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        ExtentLogger.logXMLResponse(response.asPrettyString());
            ...
            if(response.getBody().asString().contains("Required data missing: seat number")){
                flightFound = true;
            }
        ...
        Assert.assertTrue(response.getBody().asString().contains("Required data missing: seat number"),
                "Do not contains Required data missing: seat number in response");
        ExtentLogger.info("Assertion passed - contains Required data missing: seat number");
