...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        ExtentLogger.logXMLResponse(response.asPrettyString());
                ...
                if(response.getBody().asString().contains("Success") && response.getBody().asString().contains("UndoBlockSeat")){
                    flightFound = true;
                }
        ...
        Assert.assertTrue(response.getBody().asString().contains("UndoBlockSeat"),"Not contains UndoBlockSeat in response");
        ExtentLogger.info("Assertion passed - contains UndoBlockSeat");
