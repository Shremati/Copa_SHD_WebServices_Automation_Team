...
public class close_flight extends FrameworkConstants {
    ...
    public static void Execute() throws IOException, ParserConfigurationException, TransformerException, SAXException
    {
        ...
        Assign_aircraft_close_flight Prerequisite = new Assign_aircraft_close_flight();
        Prerequisite.run();

        ExtentLogger.info("Prerequisite 2");
        Restrict_checkin_close_flight Prerequisite2 = new Restrict_checkin_close_flight();
        Prerequisite2.run();
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"DepartureControlService\\close_flight.xml"));
        ...
        Assert.assertTrue(response.getBody().asString().contains("CloseFlightForDeparture"),"Not contains CloseFlightForDeparture in response");
        ExtentLogger.info("Assertion passed - contains CloseFlightForDeparture");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"DepartureControlService\\close_flight.xml";
