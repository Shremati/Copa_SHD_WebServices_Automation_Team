...
public class reinstate_connecting_passengers extends FrameworkConstants
{
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("UndoCancelMisconnects"),"Not contains UndoCancelMisconnects in response");
        ExtentLogger.info("Assertion passed - contains UndoCancelMisconnects");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"DepartureControlService\\reinstate_connecting_passengers.xml";
