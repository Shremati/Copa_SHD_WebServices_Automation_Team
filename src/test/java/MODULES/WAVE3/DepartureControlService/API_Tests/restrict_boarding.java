...
import MODULES.WAVE3.DepartureControlService.PreRequisites.Assign_aircraft_restrict_boarding;
...
public class restrict_boarding extends FrameworkConstants
{
    ...
    public static void Execute() throws IOException, ParserConfigurationException, TransformerException, SAXException
    {
        ...
        Assign_aircraft_restrict_boarding Prerequisite1 = new Assign_aircraft_restrict_boarding();
        Prerequisite1.run();
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"DepartureControlService\\restrict_boarding.xml"));
        ...
        Assert.assertTrue(response.getBody().asString().contains("WeightRestriction"),"Not contains WeightRestriction in response");
        ExtentLogger.info("Assertion passed - contains WeightRestriction");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"DepartureControlService\\restrict_boarding.xml";
