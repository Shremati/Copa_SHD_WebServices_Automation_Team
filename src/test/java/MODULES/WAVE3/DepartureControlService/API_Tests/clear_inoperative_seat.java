...
public class clear_inoperative_seat extends FrameworkConstants
{
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"DepartureControlService\\clear_inoperative_seat.xml"));
        ...
        Assert.assertTrue(response.getBody().asString().contains("UndoInopSeat"),"Not contains UndoInopSeat in response");
        ExtentLogger.info("Assertion passed - contains UndoInopSeat");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"DepartureControlService\\clear_inoperative_seat.xml";
