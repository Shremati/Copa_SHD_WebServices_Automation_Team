...
public class assign_aircraft extends FrameworkConstants
{
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"DepartureControlService\\assign_aircraft.xml"));
        ...
        Assert.assertTrue(response.getBody().asString().contains("AssignAircraft"),"Not contains Success in AssignAircraft");
