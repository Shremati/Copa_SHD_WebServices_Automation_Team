...
public class issue_ticket_flight_data_search_given_name_surname_41 extends FrameworkConstants
{
...
//        ********** Reading Testdata from Excel ************
        ...
        String filepath1;
        filepath1=".\\src\\test\\java\\MODULES\\WAVE3\\DisplayBookingService\\PreRequisites\\issue_ticket_flight_data_search_given_name_surname.xml";


        XMLParser.SetTagtextatIndex("tic1:RecordLocator", InputRow.getCell(10).getStringCellValue(),filepath1,0);
        XMLParser.updateAttributeValueatIndex("tic1:CreditCard", "AccountNumber",InputRow.getCell(18).getStringCellValue(),getTemp_requestPath(),0);
