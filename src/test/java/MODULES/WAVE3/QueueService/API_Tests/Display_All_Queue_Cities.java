...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("displayQueueCitiesResponse"),"Not contains \"displayQueueCitiesResponse\" in response");
        ExtentLogger.info("Assertion passed - contains \"displayQueueCitiesResponse\"");
