...
import MODULES.WAVE3.QueueService.PreRequisites.AddingQueue_Msg;
...
public class Display_And_Remove_Message_Default_City extends FrameworkConstants {

    public static String SOAPRequest;
    static RequestSpecification requestSpecification;
    public static void Execute() throws IOException, ParserConfigurationException, TransformerException, SAXException
    {
        AddingQueue_Msg PreRequisite1 = new AddingQueue_Msg();
        PreRequisite1.run();
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"QueueService\\Display_And_Remove_Message_Default_City.xml"));
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"QueueService\\Display_And_Remove_Message_Default_City.xml";

        XMLParser.updateAttributeValue("com:Source","AirlineVendorID",InputRow.getCell(1).getStringCellValue(),filepath1);
 //      PseudoCityCode Needs to be empty
