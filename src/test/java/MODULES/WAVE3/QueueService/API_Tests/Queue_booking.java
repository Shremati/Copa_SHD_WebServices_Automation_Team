...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"QueueService\\Queue_booking.xml"));
        ...
        Assert.assertTrue(response.getBody().asString().contains("queueBookingResponse"),"Not contains \"queueBookingResponse\" in response");
        ExtentLogger.info("Assertion passed - contains \"queueBookingResponse\"");
