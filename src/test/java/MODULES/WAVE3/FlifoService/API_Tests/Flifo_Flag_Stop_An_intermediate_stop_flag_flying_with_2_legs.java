...
import MODULES.WAVE3.FlifoService.PreRequisites.Update_Flifo_flag_stop_at_origin_with_2_legs;
import MODULES.WAVE3.FlifoService.PreRequisites.Update_Flifo_intermediate_stop_flag_flying_with_2_legs;
...
public class Flifo_Flag_Stop_An_intermediate_stop_flag_flying_with_2_legs extends FrameworkConstants {
    ...
    {
        Update_Flifo_intermediate_stop_flag_flying_with_2_legs Prerequisite1 = new Update_Flifo_intermediate_stop_flag_flying_with_2_legs();
        Prerequisite1.run();
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"FlifoService\\Flifo_Flag_Stop_An_intermediate_stop_flag_flying_with_2_legs.xml"));
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"FlifoService\\Flifo_Flag_Stop_An_intermediate_stop_flag_flying_with_2_legs.xml";
