...
public class Required_data_missing_date extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("DepartureDate"), "Does not contain \"DepartureDate\" in the response");
        ExtentLogger.info("Assertion passed - contains \"DepartureDate\"");

        Assert.assertTrue(response.getBody().asString().contains("Required data missing"), "Does not contain \"Required data missing\" in the response");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"FlifoService\\Required_data_missing_date.xml";
