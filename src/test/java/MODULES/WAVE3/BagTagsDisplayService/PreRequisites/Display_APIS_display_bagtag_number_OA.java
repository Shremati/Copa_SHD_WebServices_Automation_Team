...
public class Display_APIS_display_bagtag_number_OA extends FrameworkConstants {
...
//               ********** Reading the xml request file **********
        ...
        Assert.assertTrue(response.getBody().asString().contains("APIS INCOMPLETE"),
                "Do not contain APIS INCOMPLETE");
        ExtentLogger.info("Assertion passed - contain APIS INCOMPLETE");
