...
//        ********** Reading Testdata from Excel ************
        ...
        XMLParser.updateAttributeValue("air1:FlightSegment", "FlightNumber", availableFlights.get(InputRow.getCell(5).getStringCellValue() + "-" + InputRow.getCell(6).getStringCellValue()).get(i), getTemp_requestPath());
    ...
    public static void excelwriter(int i) throws IOException, ParserConfigurationException, SAXException, TransformerException {
        ...
        InputRow.getCell(2).setCellValue(availableFlights.get(InputRow.getCell(5).getStringCellValue() + "-" + InputRow.getCell(6).getStringCellValue()).get(i));
