...
public class Finalise_booking extends FrameworkConstants {
...
//               ********** Reading the xml request file **********
        ...
        Assert.assertTrue(response.getBody().asString().contains("CustLoyalty"), "Do not contain CustLoyalty");
        ExtentLogger.info("Assertion passed - contains CustLoyalty");
...
//        ********** Reading Testdata from Excel ************
        ...
        String filepath1;
        filepath1=".\\src\\test\\java\\MODULES\\WAVE3\\ManageSessions\\PreRequisites\\Finalise_booking.xml";
