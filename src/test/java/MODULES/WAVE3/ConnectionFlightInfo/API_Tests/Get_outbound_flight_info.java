...
public class Get_outbound_flight_info extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        ExtentLogger.logXMLResponse(response.asPrettyString());
            ...
            if(response.getBody().asString().contains("Success") && response.getBody().asString().contains("CM OUTBOUND CONNECTIONS FROM")){
                flightFound = true;
            }
        ...
        Assert.assertTrue(response.getBody().asString().contains("CM OUTBOUND CONNECTIONS FROM"),"DO not contain CM OUTBOUND CONNECTIONS FROM");
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload(int i) throws IOException, ParserConfigurationException, SAXException, TransformerException {
        ...
        String filepath1;
        filepath1 = getRequestDirectory() + "ConnectionFlightInfo\\Get_outbound_flight_info.xml";
