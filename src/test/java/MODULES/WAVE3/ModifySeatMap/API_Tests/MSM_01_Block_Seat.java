...
public class MSM_01_Block_Seat extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory() + "ModifySeatMap\\MSM_01_Block_Seat.xml"));
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException {
        ...
        XSSFRow InputRow = sheet.getRow(1); //The given seat should be available

        String filepath1;
        filepath1 = getRequestDirectory() + "ModifySeatMap\\MSM_01_Block_Seat.xml";
