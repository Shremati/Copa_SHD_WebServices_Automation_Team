...
public class MSM_02_Add_Seat extends FrameworkConstants {
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException {
        ...
        XSSFRow InputRow = sheet.getRow(2); //The given seat should be available

        String filepath1;
        filepath1 = getRequestDirectory() + "ModifySeatMap\\MSM_02_Add_Seat.xml";
