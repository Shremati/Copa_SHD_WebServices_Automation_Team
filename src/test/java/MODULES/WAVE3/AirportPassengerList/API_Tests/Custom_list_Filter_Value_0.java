...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("SecurityCode=\"N\""), "Does not contain\"SecurityCode=\\\"N\\\"\" in the response");
        ExtentLogger.info("Assertion passed - contains \"SecurityCode=\\\"N\\\"\"");
