...
import MODULES.WAVE3.AirportPassengerList.PreRequisites.issue_ticket_Eticketed_passengers_not_checked_in_04;
...
public class Eticketed_passengers_not_checked_in_04 extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory()+"AirportPassengerList\\Eticketed_passengers_not_checked_in_04.xml"));
...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        String filepath1;
        filepath1=getRequestDirectory()+"AirportPassengerList\\Eticketed_passengers_not_checked_in_04.xml";
