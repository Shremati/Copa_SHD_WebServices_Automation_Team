...
//        We need to give 2nd segment details i.e. 2nd seg flight number ,departure airport and date as its inbound
        ...
        XMLParser.updateAttributeValue("com:DepartureAirport","LocationCode",InputRow.getCell(13).getStringCellValue(),getTemp_requestPath()); //arrival airport of 1st seg
