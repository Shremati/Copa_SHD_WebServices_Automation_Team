...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("RPH=\"3\""),
                "Do not contain RPH=\"3\"");  //New segment gets added
        ExtentLogger.info("Assertion passed - contains RPH=\"3\"");
