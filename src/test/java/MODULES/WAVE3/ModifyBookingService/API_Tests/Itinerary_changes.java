...
//                ********* Clearing Temp_Request.xml *********
    ...
    public static void UpdatePayload() throws IOException, ParserConfigurationException, SAXException, TransformerException
    {
        ...
        XMLParser.updateAttributeValueatIndex("air1:FlightSegment","DepartureDateTime",InputRow.getCell(15).getStringCellValue(),getTemp_requestPath(),1);
        ...
        XMLParser.updateAttributeValueatIndex("air1:FlightSegment","ArrivalDateTime",InputRow.getCell(17).getStringCellValue(),getTemp_requestPath(),1);
