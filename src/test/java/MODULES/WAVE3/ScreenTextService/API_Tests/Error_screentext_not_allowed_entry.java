...
public class Error_screentext_not_allowed_entry extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("Invalid ScreenText request - A"),
                "Do not contain Invalid ScreenText request - A");
        ExtentLogger.info("Assertion passed - contains Invalid ScreenText request - A");
