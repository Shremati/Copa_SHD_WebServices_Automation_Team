...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("<ns4:TextData>IS CM</ns4:TextData>"),
                "Do not contain <ns4:TextData>IS CM</ns4:TextData>");
        ExtentLogger.info("Assertion passed - contains <ns4:TextData>IS CM</ns4:TextData>");
