...
//        XMLParser.updateAttributeValueatIndex("air1:FlightSegment", "FlightNumber", InputRow.getCell(17).getStringCellValue(), getTemp_requestPath(), 2);
        ...
        XMLParser.updateAttributeValue("air1:FlightSegment", "FlightNumber", availableFlights.get(InputRow.getCell(18).getStringCellValue() + "-" + InputRow.getCell(19).getStringCellValue()).get(i), getTemp_requestPath());
...
//        XMLParser.updateAttributeValueatIndex("air1:FlightSegment", "FlightNumber", InputRow.getCell(22).getStringCellValue(), getTemp_requestPath(), 3);
        ...
        XMLParser.updateAttributeValue("air1:FlightSegment", "FlightNumber", availableFlights.get(InputRow.getCell(23).getStringCellValue() + "-" + InputRow.getCell(24).getStringCellValue()).get(i), getTemp_requestPath());
...
//      5th Leg
        ...
        XMLParser.updateAttributeValue("air1:FlightSegment", "FlightNumber", availableFlights.get(InputRow.getCell(27).getStringCellValue() + "-" + InputRow.getCell(28).getStringCellValue()).get(i), getTemp_requestPath());
...
//        XMLParser.updateAttributeValueatIndex("air1:FlightSegment", "FlightNumber", InputRow.getCell(30).getStringCellValue(), getTemp_requestPath(), 5);
        ...
        XMLParser.updateAttributeValue("air1:FlightSegment", "FlightNumber", availableFlights.get(InputRow.getCell(31).getStringCellValue() + "-" + InputRow.getCell(32).getStringCellValue()).get(i), getTemp_requestPath());
