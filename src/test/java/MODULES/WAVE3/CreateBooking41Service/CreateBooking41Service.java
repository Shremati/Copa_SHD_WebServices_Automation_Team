package MODULES.WAVE3.CreateBooking41Service;

import MODULES.WAVE3.CreateBooking41Service.API_Tests.*;
...
public class CreateBooking41Service {

    CreateBooking41Service() {
        createFolders(getResponseDirectory() + "CreateBooking41Service");
    }
    ...
    public void Scenario1() {
        try {
            create_booking_1seg_1pax_stored_fare_1telephone_ticketing_41.Execute();
    ...
    public void Scenario2() {
        try {
            create_booking_four_seg_two_pax_two_SSR_41.Execute();
    ...
    public void Scenario3() {
        try {
            create_booking_four_seg_2_pax_one_remark_asa_41.Execute();
    ...
    public void Scenario4() {
        try {
            check_for_invalid_ticketing_in_request_41.Execute();
    ...
    public void Scenario5() {
        try {
            check_for_invalid_priceinfo_in_request_41.Execute();
    ...
    public void Scenario6() {
        try {
            add_a_default_time_limit_when_no_data_is_specified_in_ticketing_41.Execute();
    ...
    public void Scenario7() {
        try {
            create_booking_1seg_1pax_stored_fare_time_limit_41.Execute();
    ...
    public void Scenario8() {
        ...
        try {
            create_booking_2seg_2pax_stored_fare_41.Execute();
    ...
    public void Scenario9() {
        try {
            create_booking_2seg_2pax_stored_fare_per_pax_41.Execute();
    ...
    public void Scenario10() {
        try {
            stored_fare_ticketing_item_invalid_bagagge_allowance_41.Execute();
    ...
    public void Scenario11() {
        try {
            waitlist_booking_action_code_LL_41.Execute();
    ...
    public void Scenario13() {
        try {
            special_passenger_type_non_revenue_space_available_staff_travel_41.Execute();
    ...
    public void Scenario14() {
        try {
            special_passenger_type_jumpseat_41.Execute();
    ...
    public void Scenario15() {
        try {
            passengers_with_frequent_traveler_number_for_reward_redemption_ssr_fqtr_and_name_remark_41.Execute();
    ...
    public void Scenario16() {
        try {
            add_the_form_of_payment_remark_and_the_fop_in_the_stored_fare_41.Execute();
