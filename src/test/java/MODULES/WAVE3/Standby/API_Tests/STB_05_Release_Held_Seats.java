...
public class STB_05_Release_Held_Seats extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("SEATS UNHELD"),"Not contains \"SEATS UNHELD\" in response");
        ExtentLogger.info("Assertion passed - contains \"SEATS UNHELD\"");
