...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        Assert.assertTrue(response.getBody().asString().contains("STANDBY BOARDING COMPLETE -PARTIAL Y"),"Not contains \"STANDBY BOARDING COMPLETE -PARTIAL Y\" in response");
        ExtentLogger.info("Assertion passed - contains \"STANDBY BOARDING COMPLETE -PARTIAL Y\"");
