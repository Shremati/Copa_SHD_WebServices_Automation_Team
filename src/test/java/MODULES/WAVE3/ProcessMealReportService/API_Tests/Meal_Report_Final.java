...
public class Meal_Report_Final extends FrameworkConstants {
...
//    ******** Read the updated request and send it to fetch the response *********
        ...
        ExtentLogger.info("Base URL : " + getBaseURL() + getProcessmealreport());
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter(getResponseDirectory() + "ProcessMealReport\\Meal_Report_Final.xml"));
        ...
        Assert.assertTrue(response.getBody().asString().contains("FINAL MEAL ORDER"),
                "Do not contain FINAL MEAL ORDER");
        ExtentLogger.info("Assertion passed - contains FINAL MEAL ORDER");
